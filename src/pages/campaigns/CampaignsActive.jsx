...
const { FiGift, FiUsers, FiTrendingUp, FiPause, FiPlay, FiEdit, FiBarChart2 } = FiIcons;
...
const CampaignsActive = () => {
  ...
  const getPlatformIcon = (platform) => {
    switch (platform) {
      ...
      case 'tiktok':
        return FiIcons.FiVideo;
      case 'twitter':
        return FiIcons.FiMessageSquare;
      case 'all':
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <SafeIcon icon={FiGift} className="w-8 h-8 text-blue-600" />
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <SafeIcon icon={FiGift} className="w-8 h-8 text-orange-600" />
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-2">
                      <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                        <SafeIcon icon={campaign.status === 'active' ? FiPause : FiPlay} className="w-4 h-4 text-gray-600" />
                      </button>
                      <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
