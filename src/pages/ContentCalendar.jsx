...
const ContentCalendar = () => {
  ...
  const todayContent = [
    { id: 1, time: '09:00 AM', platform: 'Instagram', content: 'Morning wellness tips', status: 'scheduled' },
    { id: 2, time: '12:00 PM', platform: 'TikTok', content: 'Product showcase video', status: 'draft' },
    { id: 3, time: '03:00 PM', platform: 'Twitter', content: 'Customer testimonial', status: 'scheduled' },
    { id: 4, time: '06:00 PM', platform: 'Instagram', content: 'Evening routine tips', status: 'scheduled' },
  ];
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <button className="p-1 hover:bg-gray-100 rounded">
                      <SafeIcon icon="ChevronLeft" className="w-4 h-4 text-gray-600" />
                    </button>
                    <button className="p-1 hover:bg-gray-100 rounded">
                      <SafeIcon icon="ChevronRight" className="w-4 h-4 text-gray-600" />
                    </button>
                  </div>
                </div>
                <button className="flex items-center space-x-2 text-sm text-gray-600 hover:text-gray-900">
                  <SafeIcon icon="Filter" className="w-4 h-4" />
                  <span>Filter</span>
                </button>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {todayContent.map((item) => (
                <div key={item.id} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                  <SafeIcon icon="Clock" className="w-4 h-4 text-gray-400 mt-0.5" />
