...
const { FiMail, FiPlus, FiEdit, FiCopy, FiTrash2, FiPlay, FiPause, FiBarChart2 } = FiIcons;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <SafeIcon icon={FiIcons.FiEye} className="w-8 h-8 text-purple-600" />
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <SafeIcon icon={FiIcons.FiMousePointer} className="w-8 h-8 text-orange-600" />
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        ...
                        {sequence.automation && (
                          <span className="text-sm text-green-600 flex items-center space-x-1">
                            <SafeIcon icon={FiIcons.FiCpu} className="w-3 h-3" />
                            <span>Automated</span>
                          </span>
                        )}
                      </div>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-2">
                      <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                        <SafeIcon icon={sequence.status === 'active' ? FiPause : FiPlay} className="w-4 h-4 text-gray-600" />
                      </button>
                      <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
